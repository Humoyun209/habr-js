            ...
            (
                <div className="bg-white flex flex-col justify-center items-center gap-10 py-10 px-20">
                    ...
                    <div className=" flex flex-col justify-center items-center">
                        <p className="text-secondary text-[16px]">Здесь вы можете разместить баннер компании</p>
                        <span className="text-secondary text-[16px]">Рекомендуемый размер 762х200px</span>
                    </div>
