            ...
            {isAuth ? (
                <>
                    <p className="text-secondary text-[14px]">
                        Работодатель прежде всего смотрит на ваш профиль, но вы также можете
                        сопроводить свой отклик парой слов, чтобы привлечь внимание к своим самым
                        важным профессиональным или личным качествам.{' '}
                    </p>
                    <form
                ...
                <div className=" flex flex-col gap-7 justify-center items-center">
                    <img
                        width={'86px'}
                        src="https://career.habr.com/assets/packs/media/images/no_content.icon.response-5b165cac.svg"
                        alt=""
                    />
