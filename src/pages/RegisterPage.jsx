...
const RegisterPage = () => {
    ...
    const handleSubmit = (event) => {
        ...
        if (username && email && password && password2 && password === password2) {
            dispatch(registerThunkAction(JSON.stringify({
            ...
            <div className="flex flex-col gap-8 bg-white p-5" >
                ...
                <form method="post" className="flex flex-col gap-10" onSubmit={handleSubmit}>
                    <div className="flex flex-col gap-3">
                        ...
                        <input name="email" type="email" className="w-full border border-secondary p-2 outline-none"/>
                    </div>
                    <div className="flex flex-col gap-3">
                        <span className="font-semibold text-[16px]">Никнейм</span>
                        <input name="username" type="text" className="w-full border border-secondary p-2 outline-none"/>
                    </div>
                    <div className="flex flex-col gap-3">
                        <span className="font-semibold text-[16px]">Пароль</span>
                        <input name="password" type="password" className="w-full border border-secondary p-2 outline-none"/>
                    </div>
                    <div className="flex flex-col gap-3">
                        <span className="font-semibold text-[16px]">Пароль ещё раз</span>
                       <input name="password2" type="password" className="w-full border border-secondary p-2 outline-none"/>
                    </div>
