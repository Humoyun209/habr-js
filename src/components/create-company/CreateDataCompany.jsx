...
import { useGetCitiesQuery } from '../../feautures/company/actions'
        ...
        <div className=" bg-white py-8 pl-5 pr-20 flex flex-col gap-8 my-5">
            ...
            <div className="flex flex-col gap-2 text-primary">
                ...
                <span className=" text-secondary text-[14px]">
                    Укажите, как будет отображаться название компании для пользователей.
                </span>
                <Controller
                    name="name"
                    defaultValue=""
            ...
            <div className="flex flex-col gap-2 text-primary">
                ...
                <span className=" text-secondary text-[14px]">
                    Укажите ссылку на сайт или одну из соцсетей компании. Ссылка должна начинаться с
                    http:// или https://.
                </span>
                <Controller
                    name="url"
            ...
            <div className="flex flex-col gap-2 text-primary">
                ...
                <span className=" text-secondary text-[14px]">
                    Укажите номер, по которому специалисты могут связаться с вашей компанией.
                </span>
                <Controller
                    name="phone"
                    defaultValue=""
            ...
            <div className="flex flex-col gap-2 text-primary">
                ...
                <span className=" text-secondary text-[14px]">
                    Укажите Email, по которому можно вам написать
                </span>
                <Controller
                    name="email"
                    defaultValue=""
            ...
            <div className="flex flex-col gap-2 text-primary">
                ...
                <span className=" text-secondary text-[14px]">
                    Укажите где находится ваша компания
                </span>
                <Controller
                    name="city"
                    control={control}
